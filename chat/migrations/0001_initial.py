# Generated by Django 5.0.2 on 2025-04-23 06:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['timestamp'],
                'indexes': [models.Index(fields=['room', 'timestamp'], name='chat_messag_room_id_645da7_idx'), models.Index(fields=['status'], name='chat_messag_status_8c4650_idx')],
            },
        ),
    ]
